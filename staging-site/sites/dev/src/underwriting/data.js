    ...
    // ==================== 3. RISK MODEL ====================
    {
      ...
      subsections: [
        ...
        },
        {
          ...
          narrative: 'Per-line-item risk-score contribution. Gross = score contribution without Bastion controls in place. Net = residual contribution after Bastion enforcement during the assessment period. Reduction = applied-controls credit per line item.',
          table: {
            columns: ['Line Item', 'Count', 'Per-Event Weight', 'Gross', 'Residual', 'Net'],
            rows: [
              ['PII records (detected)',         '4', '4.0',  '16.0', '0', '0.0'],
              ['Tool-violation attempts',        '2', '12.0', '24.0', '0', '0.0'],
              ['Session rollback (ops)',         '1', '1.5',  '1.5',  '1', '1.5'],
              ['Total risk contribution',        '',  '',     '41.5', '',  '1.5'],
              ['Reduction (delta)',              '',  '',     '',     '',  '-40.0'],
            ],
          },
        },
      ],
      ...
      subsections: [
        {
          ...
          table: {
            ...
            rows: [
              ...
              ['BSTN-F-2026-05-16-011', '2026-05-16 10:28', 'acme_phone_ai', 'third_party_disclosure', 'High', 'Blocked inline', 'AI-RMF:MEASURE-2.10 · OWASP:LLM06'],
              ['BSTN-F-2026-05-14-047', '2026-05-14 15:51', 'acme_phone_ai', 'divergence', 'Medium', 'Remediated', 'AI-RMF:MEASURE-2.3 · OWASP:LLM09'],
            ],
          },
        },
        {
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ...
              ['SEV-3 Moderate', '4', '44.4%', '4.0'],
              ['SEV-4 Minor',    '3', '33.3%', '1.5'],
              ['SEV-5 Info',     '1', '11.1%', '0.5'],
            ],
          },
        },
      ],
      ...
      subsections: [
        {
          ...
          table: {
            ...
            rows: [
              ['Phone number',                '2', '2', '0', '4.0', '0.0'],
              ['Physical address',            '1', '1', '0', '4.0', '0.0'],
              ['Named person (third-party)',  '1', '1', '0', '4.0', '0.0'],
              ['Email',                       '0', '0', '0', '4.0', '0.0'],
              ['SSN / SIN',                   '0', '0', '0', '8.0', '0.0'],
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ...
              ['Methodology', 'Risk scores use the weighted component model: PII (30%), Policy (25%), Anomaly (20%), Integrity (15%), Drift (10%). Per-line-item contributions are weight × event count, normalised against a 100-point ceiling. Severity follows NIST IR framework adapted for AI failure modes.'],
